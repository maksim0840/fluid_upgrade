...
// В моей реализации передачи параметров в класс-эмулятор используются шаблоны типов.
// Шаблоны предполагают, что все передаваемые в них значения заранее известны.
// Данное ограничение повлекло за собой реализацию определения всех передаваемых значений во время компиляции.
